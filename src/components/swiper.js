    ...
    <>
      <Stack direction='column' gap={3}>
        <Stack direction="row"   >
          <Swiper >
            <div className='container'>
              <SwiperSlide >
                <img src="https://picsum.photos/id/1018/1000/600/" alt=" " style={{ width: "90%" }} />
              </SwiperSlide >
              <SwiperSlide>
                <img src="https://picsum.photos/id/1015/1000/600/" alt=" " style={{ width: "90%" }} />
              </SwiperSlide >
              <SwiperSlide >
                <img src="https://picsum.photos/id/1019/1000/600/" alt=" " style={{ width: "90%" }} />
              </SwiperSlide >
            </div>
          </Swiper>
          <div className=' w-[100%] text-left  text-xl font-semibold' >
        ...
        <Stack direction="row" gap={5}>
          <div className='border rounded-lg border-grey p-4 w-[50%] h-[250px]'>
         ...
         <span>Material</span>  
          ...
          <div className='border rounded-lg border-grey p-4 w-[40%] h-[200px]'>
        ...
        <Stack drection='row'>
          <div className='border rounded-lg border-grey p-4 h-[250px] w-[95%]'>
